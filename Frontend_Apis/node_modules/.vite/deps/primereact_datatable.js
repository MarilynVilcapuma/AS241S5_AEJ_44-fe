...
import { C as classNames, S as ZIndexUtils, _ as DomHandler, b as ObjectUtils, d as ariaLabel$2, n as FilterOperator, o as PrimeReact$2, p as localeOption, r as FilterService, s as PrimeReactContext, t as FilterMatchMode$2, v as EventBus, x as UniqueComponentId, y as IconUtils } from "./api.esm-BtFgCArl.js";
import { c as useMergeProps, f as usePrevious, g as useUpdateEffect, h as useUnmountEffect, i as useDebounce, l as useMountEffect, m as useStyle, n as useHandleStyle, o as useEventListener, p as useResizeListener, t as ComponentBase, u as useOverlayListener } from "./componentbase.esm-2YKMmCrl.js";
import { n as IconBase, t as Ripple } from "./ripple.esm-BzAaRZLq.js";
import { n as SpinnerIcon, t as Button } from "./button.esm-BkSJPkLE.js";
import { t as Portal } from "./portal.esm-DJJ2cW53.js";
import { t as Tooltip } from "./tooltip.esm-CTqajfxa.js";
import { t as InputText } from "./inputtext.esm-DyEvW3VV.js";
...
var InputNumber = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	...
	*/
	...
	var createInputElement = function createInputElement() {
		...
		return /* @__PURE__ */ import_react.createElement(InputText, _extends$20({
			ref: inputRef,
			id: props.inputId,
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement("span", _extends$20({ ref: elementRef }, rootProps), inputElement, buttonGroup), hasTooltip && /* @__PURE__ */ import_react.createElement(Tooltip, _extends$20({
		target: elementRef,
...
var VirtualScroller = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	...
	var setSpacerSize = function setSpacerSize() {
		...
		if (items) {
			...
			var setProp = function setProp(_name, _value, _size) {
				...
				return spacerStyle.current = _objectSpread$11(_objectSpread$11({}, spacerStyle.current), _defineProperty$3({}, "".concat(_name), (_value || []).length * _size + _cpos + "px"));
			};
			if (both) {
	...
	var setContentPosition = function setContentPosition(pos) {
		if (_contentRef.current && !props.appendOnly) {
			...
			var setTransform = function setTransform() {
				...
				contentStyle.current = _objectSpread$11(_objectSpread$11({}, contentStyle.current), { transform: "translate3d(".concat(_x, "px, ").concat(_y, "px, 0)") });
			};
	...
	var createLoader = function createLoader() {
		...
		var icon = props.loadingIcon || /* @__PURE__ */ import_react.createElement(SpinnerIcon, _extends$13({}, loadingIconProps, { spin: true }));
...
function _objectSpread$2$11(e) {
	for (var r = 1; r < arguments.length; r++) {
		var t = null != arguments[r] ? arguments[r] : {};
		r % 2 ? ownKeys$2$11(Object(t), !0).forEach(function(r) {
			_defineProperty$2(e, r, t[r]);
		}) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys$2$11(Object(t)).forEach(function(r) {
			Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r));
		});
	}
	return e;
	...
	css: {
		...
		inlineStyles: {
			...
			panel: function panel(_ref0) {
				...
				return _objectSpread$2$11({}, props.panelStyle);
			}
		}
	}
});
...
var DropdownItem = /* @__PURE__ */ import_react.memo(function(props) {
	...
	return /* @__PURE__ */ import_react.createElement("li", _extends$11({ key: props.label }, itemProps), checkmark && function iconRenderer() {
		if (selected) {
...
var DropdownPanel = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(props, ref) {
	...
	var getPTOptions = function getPTOptions(key, options) {
		return ptm(key, _objectSpread$1$7({ hostName: props.hostName }, options));
	};
	...
	var createItem = function createItem(option, index) {
		...
		style = _objectSpread$1$7(_objectSpread$1$7({}, style), option.style);
		if (option.group && props.optionGroupLabel) {
			...
			return /* @__PURE__ */ import_react.createElement("li", _extends$11({ key }, itemGroupProps), /* @__PURE__ */ import_react.createElement("span", itemGroupLabelProps, groupContent));
		}
	...
	var createFilterClearIcon = function createFilterClearIcon() {
		if (props.showFilterClear && props.filterValue) {
			...
			return IconUtils.getJSXIcon(icon, _objectSpread$1$7({}, clearIconProps), { props });
		}
		return null;
	};
	var createFilter = function createFilter() {
		if (props.filter) {
			...
			var filterIcon = IconUtils.getJSXIcon(icon, _objectSpread$1$7({}, filterIconProps), { props });
	...
	var createContent = function createContent() {
		if (props.virtualScrollerOptions) {
			var virtualScrollerProps = _objectSpread$1$7(_objectSpread$1$7({}, props.virtualScrollerOptions), {
				style: _objectSpread$1$7(_objectSpread$1$7({}, props.virtualScrollerOptions.style), { height: props.scrollHeight }),
				className: classNames("p-dropdown-items-wrapper", props.virtualScrollerOptions.className),
				items: props.visibleOptions,
				autoSize: true,
				onLazyLoad: function onLazyLoad(event) {
					return props.virtualScrollerOptions.onLazyLoad(_objectSpread$1$7(_objectSpread$1$7({}, event), { filter: props.filterValue }));
				},
			...
			return /* @__PURE__ */ import_react.createElement(VirtualScroller, _extends$11({ ref: props.virtualScrollerRef }, virtualScrollerProps, { pt: ptm("virtualScroller") }));
		}
		var items = createItems();
	...
	var element = function createElement() {
		...
		return /* @__PURE__ */ import_react.createElement(CSSTransition, _extends$11({ nodeRef: ref }, transitionProps), /* @__PURE__ */ import_react.createElement("div", _extends$11({ ref }, panelProps), props.firstFocusableElement, filter, content, footer, props.lastFocusableElement));
	}();
...
var Dropdown = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	...
	var _DropdownBase$setMeta = DropdownBase.setMetaData(_objectSpread$12(_objectSpread$12({ props }, props.__parentMetadata), {}, { state: {
		filter: filterState,
	...
	var flatOptions = function flatOptions(options) {
		return (options || []).reduce(function(result, option, index) {
			result.push(_objectSpread$12(_objectSpread$12({}, option), {}, {
				group: true,
				index
			}));
			...
			if (props.optionGroupLabel) {
				...
				try {
					for (_iterator.s(); !(_step = _iterator.n()).done;) {
						...
						if (filteredSubOptions && filteredSubOptions.length) filteredGroups.push(_objectSpread$12(_objectSpread$12({}, optgroup), _defineProperty$2({}, "".concat(props.optionGroupChildren), filteredSubOptions)));
					}
				} catch (err) {
					_iterator.e(err);
				} finally {
	...
	var createHiddenSelect = function createHiddenSelect() {
		...
		if (selectedOption) {
			...
			option = {
				value: _typeof$2(optionValue) === "object" ? props.options.findIndex(function(o) {
	...
	var createKeyboardHelper = function createKeyboardHelper() {
		...
		var inputProps = mergeProps(_objectSpread$12({
			ref: focusInputRef,
			id: props.inputId,
			defaultValue: value,
			type: "text",
	...
	var createLabel = function createLabel() {
		...
		if (props.editable) {
			var _inputProps = mergeProps(_objectSpread$12({
				ref: inputRef,
				type: "text",
	...
	var createClearIcon = function createClearIcon() {
		if (props.value != null && props.showClear && !props.disabled && !ObjectUtils.isEmpty(props.options)) {
			...
			return IconUtils.getJSXIcon(icon, _objectSpread$12({}, clearIconProps), { props });
		}
		return null;
	};
	var createLoadingIcon = function createLoadingIcon() {
		...
		var loadingIcon = IconUtils.getJSXIcon(icon, _objectSpread$12({}, loadingIconProps), { props });
	...
	var createDropdownIcon = function createDropdownIcon() {
		...
		var dropdownIcon = IconUtils.getJSXIcon(icon, _objectSpread$12({}, dropdownIconProps), { props });
		var ariaLabel = props.placeholder || props.ariaLabel;
	...
	return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, /* @__PURE__ */ import_react.createElement("div", rootProps, keyboardHelper, hiddenSelect, labelElement, clearIcon, dropdownIcon, /* @__PURE__ */ import_react.createElement(DropdownPanel, _extends$11({
		hostName: "Dropdown",
		ref: overlayRef,
		visibleOptions,
		virtualScrollerRef
		...
		sx
	}))), hasTooltip && /* @__PURE__ */ import_react.createElement(Tooltip, _extends$11({
		target: elementRef,
		content: props.tooltip,
		pt: ptm("tooltip")
	}, props.tooltipOptions)));
...
var FirstPageLink = /* @__PURE__ */ import_react.memo(function(inProps) {
	...
	var firstPageLinkIcon = IconUtils.getJSXIcon(icon, _objectSpread$4$1({}, firstPageIconProps), { props });
...
var LastPageLink = /* @__PURE__ */ import_react.memo(function(inProps) {
	...
	var lastPageLinkIcon = IconUtils.getJSXIcon(icon, _objectSpread$3$1({}, lastPageIconProps), { props });
...
var NextPageLink = /* @__PURE__ */ import_react.memo(function(inProps) {
	...
	var nextPageLinkIcon = IconUtils.getJSXIcon(icon, _objectSpread$2$1({}, nextPageIconProps), { props });
...
var PrevPageLink = /* @__PURE__ */ import_react.memo(function(inProps) {
	...
	var prevPageLinkIcon = IconUtils.getJSXIcon(icon, _objectSpread$1$1({}, prevPageIconProps), { props });
...
var Paginator = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	...
	var metaData = _objectSpread$10({ props }, props.__parentMetadata);
	...
	var createElements = function createElements() {
		...
		if (template) {
			if (_typeof$1(template) === "object") return template.layout ? template.layout.split(" ").map(function(value) {
				var key = value.trim();
