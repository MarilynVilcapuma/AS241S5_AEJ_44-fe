...
import { C as classNames, S as ZIndexUtils, _ as DomHandler, b as ObjectUtils, d as ariaLabel, o as PrimeReact, s as PrimeReactContext, x as UniqueComponentId, y as IconUtils } from "./api.esm-BtFgCArl.js";
import { a as useDisplayOrder, c as useMergeProps, g as useUpdateEffect, h as useUnmountEffect, l as useMountEffect, m as useStyle, n as useHandleStyle, o as useEventListener, r as ESC_KEY_HANDLING_PRIORITIES, s as useGlobalOnEscapeKey, t as ComponentBase } from "./componentbase.esm-2YKMmCrl.js";
import { n as IconBase, t as Ripple } from "./ripple.esm-BzAaRZLq.js";
import { t as Portal } from "./portal.esm-DJJ2cW53.js";
import { n as TimesIcon, t as CSSTransition } from "./csstransition.esm-CFJNV69a.js";
//#region node_modules/primereact/icons/windowmaximize/index.esm.js
...
var WindowMaximizeIcon = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
...
//#endregion
//#region node_modules/primereact/icons/windowminimize/index.esm.js
function _extends$1() {
...
var WindowMinimizeIcon = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	var pti = IconBase.getPTI(inProps);
...
//#endregion
//#region node_modules/primereact/dialog/dialog.esm.js
function _extends() {
...
var FocusTrap$1 = /* @__PURE__ */ import_react.memo(/* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	...
	FocusTrapBase.setMetaData(_objectSpread$2({}, metaData)).ptm;
...
var DialogBase = ComponentBase.extend({
	...
	css: {
		...
		inlineStyles: { mask: function mask(_ref6) {
...
var Dialog = /* @__PURE__ */ import_react.forwardRef(function(inProps, ref) {
	var mergeProps = useMergeProps();
	var context = import_react.useContext(PrimeReactContext);
	var props = DialogBase.getProps(inProps, context);
	var uniqueId = props.id ? props.id : UniqueComponentId();
	var _React$useState2 = _slicedToArray(import_react.useState(uniqueId), 2), idState = _React$useState2[0];
	_React$useState2[1];
	var _React$useState4 = _slicedToArray(import_react.useState(false), 2), maskVisibleState = _React$useState4[0], setMaskVisibleState = _React$useState4[1];
	var _React$useState6 = _slicedToArray(import_react.useState(false), 2), visibleState = _React$useState6[0], setVisibleState = _React$useState6[1];
	var _React$useState8 = _slicedToArray(import_react.useState(props.maximized), 2), maximizedState = _React$useState8[0], setMaximizedState = _React$useState8[1];
	var dialogRef = import_react.useRef(null);
	var maskRef = import_react.useRef(null);
	var pointerRef = import_react.useRef(null);
	var contentRef = import_react.useRef(null);
	var headerRef = import_react.useRef(null);
	var footerRef = import_react.useRef(null);
	var closeRef = import_react.useRef(null);
	var dragging = import_react.useRef(false);
	var resizing = import_react.useRef(false);
	var lastPageX = import_react.useRef(null);
	var lastPageY = import_react.useRef(null);
	var styleElement = import_react.useRef(null);
	var attributeSelector = import_react.useRef(uniqueId);
	var focusElementOnHide = import_react.useRef(null);
	...
	var _DialogBase$setMetaDa = DialogBase.setMetaData(_objectSpread(_objectSpread({ props }, props.__parentMetadata), {}, { state: {
		id: idState,
		maximized,
	...
	}), 2), bindDocumentResizeListener = _useEventListener2[0], unbindDocumentResizeListener = _useEventListener2[1];
	...
	}), 2), bindDocumentResizeEndListener = _useEventListener4[0], unbindDocumentResizEndListener = _useEventListener4[1];
	...
	}), 2), bindDocumentDragListener = _useEventListener6[0], unbindDocumentDragListener = _useEventListener6[1];
	...
	}), 2), bindDocumentDragEndListener = _useEventListener8[0], unbindDocumentDragEndListener = _useEventListener8[1];
	...
	var focus = function focus() {
		...
		if (!(activeElement && dialogRef.current && dialogRef.current.contains(activeElement)) && props.closable && props.showCloseIcon && props.showHeader && closeRef.current) closeRef.current.focus();
	};
	...
	var onMaskPointerUp = function onMaskPointerUp(event) {
		if (props.dismissableMask && props.modal && maskRef.current === event.target && !pointerRef.current) onClose(event);
	...
	var toggleMaximize = function toggleMaximize(event) {
		...
		else setMaximizedState(function(prevMaximized) {
			return !prevMaximized;
		});
		event.preventDefault();
	};
	var onDragStart = function onDragStart(event) {
		if (DomHandler.hasClass(event.target, "p-dialog-header-icon") || DomHandler.hasClass(event.target.parentElement, "p-dialog-header-icon")) return;
		if (props.draggable) {
	...
	var convertToPx = function convertToPx(value, property, viewport) {
		...
		if (/^(\d+|(\.\d+))(\.\d+)?%$/.test(value)) return val * (viewport[property] / 100);
		return val;
	};
	var onResize = function onResize(event) {
		if (resizing.current) {
			...
			if ((!minWidth || newWidth > minWidth) && (deltaX < 0 || offset.left + newWidth < viewport.width)) dialogRef.current.style.width = newWidth + "px";
			if ((!minHeight || newHeight > minHeight) && (deltaY < 0 || offset.top + newHeight < viewport.height)) dialogRef.current.style.height = newHeight + "px";
			lastPageX.current = event.pageX;
			lastPageY.current = event.pageY;
	...
	var onEntered = function onEntered() {
		...
		if (props.focusOnShow) focus();
		enableDocumentSettings();
	};
	var onExiting = function onExiting() {
		if (props.modal) !isUnstyled() && DomHandler.addClass(maskRef.current, "p-component-overlay-leave");
	};
	...
	var updateScrollBlocker = function updateScrollBlocker() {
		if (document.primeDialogParams && document.primeDialogParams.some(function(i) {
			return i.hasBlockScroll;
		})) DomHandler.blockBodyScroll();
		else DomHandler.unblockBodyScroll();
	};
	var updateGlobalDialogsRegistry = function updateGlobalDialogsRegistry(isMounted) {
		if (isMounted && visibleState) {
			...
			if (!document.primeDialogParams) document.primeDialogParams = [];
			...
			if (currentDialogIndexInRegistry === -1) document.primeDialogParams = [].concat(_toConsumableArray(document.primeDialogParams), [newParam]);
			else document.primeDialogParams = document.primeDialogParams.toSpliced(currentDialogIndexInRegistry, 1, newParam);
		} else document.primeDialogParams = document.primeDialogParams && document.primeDialogParams.filter(function(param) {
	...
	useMountEffect(function() {
		...
		if (props.visible) setMaskVisibleState(true);
	});
	import_react.useEffect(function() {
		if (props.breakpoints) createStyle();
		return function() {
			destroyStyle();
		};
	}, [props.breakpoints]);
	useUpdateEffect(function() {
		if (props.visible && !maskVisibleState) setMaskVisibleState(true);
		if (props.visible !== visibleState && maskVisibleState) setVisibleState(props.visible);
		if (props.visible) focusElementOnHide.current = document.activeElement;
	...
	var createCloseIcon = function createCloseIcon() {
		if (props.closable && props.showCloseIcon) {
			...
			var icon = props.closeIcon || /* @__PURE__ */ import_react.createElement(TimesIcon, closeButtonIconProps);
			var headerCloseIcon = IconUtils.getJSXIcon(icon, _objectSpread({}, closeButtonIconProps), { props });
			...
			return /* @__PURE__ */ import_react.createElement("button", closeButtonProps, headerCloseIcon, /* @__PURE__ */ import_react.createElement(Ripple, null));
		}
		return null;
	};
	var createMaximizeIcon = function createMaximizeIcon() {
		var icon;
		var maximizableIconProps = mergeProps({ className: cx("maximizableIcon") }, ptm("maximizableIcon"));
		if (!maximized) icon = props.maximizeIcon || /* @__PURE__ */ import_react.createElement(WindowMaximizeIcon, maximizableIconProps);
		else icon = props.minimizeIcon || /* @__PURE__ */ import_react.createElement(WindowMinimizeIcon, maximizableIconProps);
		var toggleIcon = IconUtils.getJSXIcon(icon, maximizableIconProps, { props });
		if (props.maximizable) {
			...
			return /* @__PURE__ */ import_react.createElement("button", maximizableButtonProps, toggleIcon, /* @__PURE__ */ import_react.createElement(Ripple, null));
		}
		return null;
	};
	var createHeader = function createHeader() {
		if (props.showHeader) {
			...
			var headerIconsProps = mergeProps({ className: cx("headerIcons") }, ptm("headerIcons"));
			return /* @__PURE__ */ import_react.createElement("div", headerProps, /* @__PURE__ */ import_react.createElement("div", headerTitleProps, header), /* @__PURE__ */ import_react.createElement("div", headerIconsProps, icons, maximizeIcon, closeIcon));
		}
		return null;
	};
	var createContent = function createContent() {
		...
		return /* @__PURE__ */ import_react.createElement("div", contentProps, props.children);
	};
	var createFooter = function createFooter() {
		...
		return footer && /* @__PURE__ */ import_react.createElement("div", footerProps, footer);
	};
	var createResizer = function createResizer() {
		if (props.resizable) return /* @__PURE__ */ import_react.createElement("span", {
	...
	var createElement = function createElement() {
		...
		return /* @__PURE__ */ import_react.createElement(import_react.Fragment, null, header, content, footer, resizer);
	};
	return maskVisibleState && function createDialog() {
		var headerId = idState + "_header";
		...
		if (inProps !== null && inProps !== void 0 && inProps.content) contentElement = createTemplateElement();
		else contentElement = createElement();
		var rootElement = /* @__PURE__ */ import_react.createElement("div", maskProps, /* @__PURE__ */ import_react.createElement(CSSTransition, _extends({ nodeRef: dialogRef }, transitionProps), /* @__PURE__ */ import_react.createElement("div", rootProps, /* @__PURE__ */ import_react.createElement(FocusTrap$1, { autoFocus: props.focusOnShow }, contentElement))));
