    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: '0.85rem', padding: '0.25rem 0' }}>
      ...
      <div>
        ...
        <div style={{ fontSize: '0.8rem', color: '#94a3b8', marginTop: '2px' }}>
          Descarga fotos o videos de Instagram
        </div>
      </div>
    </div>
  )
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '0.4rem', flexShrink: 0 }}>
            <div style={{
              width: 34, height: 34, borderRadius: '8px', background: '#ede9fe',
              display: 'flex', alignItems: 'center', justifyContent: 'center'
            }}>
              <i className="pi pi-image" style={{ fontSize: '1rem', color: '#7c3aed' }} />
            </div>
            <div style={{
              width: 34, height: 34, borderRadius: '8px', background: '#fce7f3',
              display: 'flex', alignItems: 'center', justifyContent: 'center'
            }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.75rem', color: '#8b5cf6', marginTop: '1px' }}>
              Descarga media de cualquier post público
            </div>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.45rem' }}>
          <label style={{ fontSize: '0.82rem', fontWeight: 600, color: '#374151', display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
            <i className="pi pi-link" style={{ color: '#fd1d1d', fontSize: '0.85rem' }} />
          ...
          <div style={fieldBox(urlDirty ? (urlValid ? true : false) : null)}>
            ...
            <InputText
              ...
              style={{
                border: 'none', outline: 'none', boxShadow: 'none',
                padding: 0, flex: 1, fontSize: '0.875rem', background: 'transparent', color: '#1e293b'
              }}
            />
        ...
        <div style={{
          ...
          <span style={{ fontSize: '0.78rem', color: '#78350f', lineHeight: 1.6 }}>
            ...
            Ej: <code style={{ background: '#fef3c7', padding: '1px 5px', borderRadius: '4px', fontFamily: 'monospace' }}>
