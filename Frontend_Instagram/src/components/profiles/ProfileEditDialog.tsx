      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem' }}>
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', flexWrap: 'wrap' }}>
              ...
              {profile.isVerified && (
                <span style={{
                  ...
                  padding: '0.1rem 0.5rem', borderRadius: '20px', fontWeight: 600
                }}>
                  Verificado
                </span>
              )}
            ...
            <div style={{
              ...
              marginTop: '6px', padding: '0.15rem 0.6rem', borderRadius: '20px',
          ...
          {stats.map(s => (
            <div key={s.label} style={{
              ...
              <div style={{
                ...
                background: '#fff', margin: '0 auto 0.4rem',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
        ...
        {profile.bio && (
          <div style={{
            ...
            <div style={{ fontSize: '0.72rem', fontWeight: 600, color: '#94a3b8', marginBottom: '0.35rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
              Biografía
            </div>
        ...
        <div style={{ borderTop: '1px solid #f1f5f9', paddingTop: '1rem', display: 'flex', gap: '0.75rem' }}>
          ...
          >
            {loading
              ...
              : <i className="pi pi-refresh" style={{ fontSize: '0.9rem' }} />
            }
