  ...
  const header = (
    <div style={{ display: 'flex', alignItems: 'center', gap: '0.85rem', padding: '0.25rem 0' }}>
      <div style={{
        ...
        boxShadow: '0 4px 14px rgba(131,58,180,0.35)'
      }}>
        <i className="pi pi-user-plus" style={{ color: '#fff', fontSize: '1.2rem' }} />
      </div>
      <div>
        <div style={{ fontWeight: 700, fontSize: '1.05rem', color: '#0f172a', lineHeight: 1.2 }}>
          Registrar Perfil
        </div>
        <div style={{ fontSize: '0.8rem', color: '#94a3b8', marginTop: '2px' }}>
          Consulta y guarda un perfil de Instagram
        </div>
      </div>
    </div>
  )
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.1rem' }}>
        ...
        {/* Banner */}
        <div style={{
          background: 'linear-gradient(135deg, #f5f3ff 0%, #fdf2f8 60%, #fff1f2 100%)',
          ...
          <div>
            <div style={{ fontWeight: 700, fontSize: '0.85rem', color: '#6d28d9' }}>
              Búsqueda en Instagram
            </div>
            <div style={{ fontSize: '0.75rem', color: '#8b5cf6', marginTop: '1px' }}>
              Se consultará la API con el username ingresado
            </div>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.45rem' }}>
          <label style={{
            ...
            <i className="pi pi-at" style={{ color: '#833ab4', fontSize: '0.85rem' }} />
            Nombre de usuario
          </label>
          <div style={{
            display: 'flex', alignItems: 'center', gap: '0.6rem',
            background: '#f8fafc',
            border: `1.5px solid ${canSubmit ? '#6366f1' : '#e2e8f0'}`,
            borderRadius: '10px', padding: '0.7rem 1rem',
            transition: 'border-color 0.2s, box-shadow 0.2s',
            boxShadow: canSubmit ? '0 0 0 3px rgba(99,102,241,0.10)' : 'none',
          }}>
            ...
            <InputText
              ...
              style={{
                ...
                padding: 0, flex: 1, fontSize: '0.9rem', background: 'transparent', color: '#1e293b'
              }}
            />
            {canSubmit && (
              <span style={{
                fontSize: '0.75rem', color: '#6366f1', fontWeight: 600,
                background: '#eef2ff', padding: '0.15rem 0.55rem',
          ...
          <div style={{ fontSize: '0.75rem', color: '#94a3b8', display: 'flex', alignItems: 'center', gap: '0.3rem' }}>
            ...
            Ingresa el username tal como aparece en Instagram
          </div>
        </div>
        ...
        <div style={{
          ...
          <span style={{ fontSize: '0.78rem', color: '#166534', lineHeight: 1.6 }}>
            Al registrar se obtendrán: foto de perfil, seguidores, posts, verificación y más datos del perfil.
          </span>
        </div>
        ...
        <div style={{ borderTop: '1px solid #f1f5f9', paddingTop: '1rem', display: 'flex', gap: '0.75rem' }}>
          ...
          <button
            ...
            style={{
              ...
              boxShadow: canSubmit ? '0 4px 14px rgba(131,58,180,0.38)' : 'none',
          ...
          >
            {loading
              ...
              : <i className="pi pi-user-plus" style={{ fontSize: '0.9rem' }} />
            }
